        ...
        <div className="w-full flex items-center">
          <div className="w-full py-3 space-y-7">
            ...
            <p className="max-w-xl leading-7">
              Unleash your wanderlust and embark on a journey of
              indulgence and discovery. Whether you're seeking a
              romantic getaway, a family adventure, or a solo
              retreat, our accommodation is the perfect choice for
              discerning travelers who crave the best.
              <br />
              Begin your extraordinary experience today by booking
              your stay with us. Let us pamper you and create
              memories that will last a lifetime. Welcome to our
              exquisite getaway, where luxury meets tranquility in
              perfect harmony.
            </p>
            <div>
